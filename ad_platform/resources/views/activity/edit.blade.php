                                ...
                                <div class="card-block">
                                    <form id='form' action="/activity/store" method="post" enctype="multipart/form-data" class="form-horizontal ">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-9">
                                                <input type="hidden" id="hidden-input" name="activity_id" value="{{$activity->activity_id}}" />
                                                <input type="text" id="text-input" name="activity_name" class="form-control" value="{{$activity->activity_name}}" placeholder="广告名称"/>
