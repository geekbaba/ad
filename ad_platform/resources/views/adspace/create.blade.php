                                ...
                                <div class="card-block">
                                    <form id='form' action="/adspace/store" method="post" enctype="multipart/form-data" class="form-horizontal ">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-9">
                                                <input type="text" id="text-input" name="advertising_space_name" class="form-control" placeholder="广告位名称">
                                                <span class="help-block">起一个好的名称能让你很好的记住它。</span>
                                            </div>
                                        </div>
                                        
                                        <div class="form-group row">
                                            <label class="col-md-3 form-control-label" for="select">广告位类型</label>
                                            <div class="col-md-9">
