            ...
            <div class="container-fluid">
                <div class="animated fadeIn">
                    ...
                    <div class="row">
                        ...
                        <!--/.col-->
                        <div class="copyrights">Collect from <a href=""  title="">Co.</a></div>
                                        ...
                                        <tbody>
                                            <tr>
                                                <td class="text-center">
                                                    <div class="avatar">
                                                        <img src="{{asset('admin/img/avatars/1.jpg')}}" class="img-avatar" alt="admin@bootstrapmaster.com">
                                                ...
                                                <td class="text-center">
                                                    <img src="{{asset('admin/img/flags/USA.png')}}" alt="USA" style="height:24px;">
                                                </td>
                                                <td>
                                                    <div class="clearfix">
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <img src="{{asset('admin/img/flags/Brazil.png')}}" alt="Brazil" style="height:24px;">
                                                </td>
                                                <td>
                                                    <div class="clearfix">
                                                        <div class="float-left">
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <img src="{{asset('admin/img/flags/India.png')}}" alt="India" style="height:24px;">
                                                </td>
                                                <td>
                                                    <div class="clearfix">
                                                        <div class="float-left">
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <img src="{{asset('admin/img/flags/France.png')}}" alt="France" style="height:24px;">
                                                </td>
                                                <td>
                                                    <div class="clearfix">
                                                        <div class="float-left">
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <img src="{{asset('admin/img/flags/Spain.png')}}" alt="Spain" style="height:24px;">
                                                </td>
                                                <td>
                                                    <div class="clearfix">
                                                        <div class="float-left">
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <img src="{{asset('admin/img/flags/Poland.png')}}" alt="Poland" style="height:24px;">
                                                </td>
                                                <td>
                                                    <div class="clearfix">
                                                        <div class="float-left">
